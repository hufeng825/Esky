...
+ (void)dismiss
{
    ...
    {
        if ([sharedDialog respondsToSelector:@selector(dismissModalViewControllerAnimated:)]) {
            [[sharedDialog presentingViewController]  performSelector:@selector(dismissModalViewControllerAnimated:) withObject:[NSNumber numberWithBool:YES]];
        } else {
    ...
    {
        if ([sharedDialog respondsToSelector:@selector(dismissModalViewControllerAnimated:)]) {
            [[sharedDialog parentViewController] performSelector:@selector(dismissModalViewControllerAnimated:) withObject:[NSNumber numberWithBool:YES]];
        } else {
	...
	if (self == sharedDialog) {
		...
		if ([self respondsToSelector:@selector(presentingViewController)])
        {
            if ([self respondsToSelector:@selector(dismissModalViewControllerAnimated:)]) {
                [[self presentingViewController] performSelector:@selector(dismissModalViewControllerAnimated:) withObject:[NSNumber numberWithBool:YES]];
            } else {
        ...
        {
            if ([self respondsToSelector:@selector(dismissModalViewControllerAnimated:)]) {
                [[self parentViewController] performSelector:@selector(dismissModalViewControllerAnimated:) withObject:[NSNumber numberWithBool:YES]];
            } else {
