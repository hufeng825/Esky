...
static const NSInteger kStarWidthAndHeight = 18;

static const NSString *kDefaultEmptyChar = @"☆";
static const NSString *kDefaultSolidChar = @"★";


@interface ESRatingControl (Private)
...
@implementation ESRatingControl
...
- (void)drawRect:(CGRect)rect
{
	...
	for (int i = 0; i < _rating; i++)
	{
		...
		else
        {
            ...
            CGContextSetFillColorWithColor(context, _solidColor.CGColor);
            [kDefaultSolidChar drawAtPoint:currPoint withAttributes:@{
	...
	for (int i = 0; i < remaining; i++)
	{
		...
		else
        {
			...
			[kDefaultEmptyChar drawAtPoint:currPoint withAttributes:@{
                                                                      NSFontAttributeName:[UIFont boldSystemFontOfSize:kFontSize],
                                                                      }
             ];
        }
