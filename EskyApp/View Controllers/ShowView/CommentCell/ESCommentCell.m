...
//                                             andMaxRating:5];
        starts = [ [ESRatingControl alloc]initWithLocation:CGPointMake(195, 68) emptyImage:[UIImage imageNamed:@"man/starempty.png"] solidImage:[UIImage imageNamed:@"man/starsolid.png"] andMaxRating:5];
    }
